...
Documentação do **super-assistente**: motor determinístico que pesa, propaga e deriva os claims de um projeto por níveis (ideação → concepção → …). LLM só na borda, injetado.
